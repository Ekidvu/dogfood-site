...
function RegisterForm({ onSubmit, onNavigateLogin, modal, path }) {
    ...
    return (
        <Form title='Регистрация' handleFormSubmit={handleSubmit(onSubmit)}>
            ...
            <FormButton type="button" color="secondary" onClick={onNavigateLogin} modal={modal} path={path}>Войти</FormButton>
        </Form>
    );
}
